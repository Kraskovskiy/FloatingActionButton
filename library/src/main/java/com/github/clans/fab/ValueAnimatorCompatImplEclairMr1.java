...
public class ValueAnimatorCompatImplEclairMr1 extends ValueAnimatorCompat.Impl {
    ...
    public int getAnimatedIntValue() {
        return AnimationUtilsNative.lerp(mIntValues[0], mIntValues[1], getAnimatedFraction());
    }
    ...
    public float getAnimatedFloatValue() {
        return AnimationUtilsNative.lerp(mFloatValues[0], mFloatValues[1], getAnimatedFraction());
    }
